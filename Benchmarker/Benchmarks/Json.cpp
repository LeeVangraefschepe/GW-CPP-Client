    ...
    auto test = [&packet, &data, &packetId, &x, &y, &blockId, &blockData]()
        {
            ...
            x = positionArray[0].GetInt();
            y = positionArray[1].GetInt();
    ...
    auto test = [&packet, &data, &packetId, &position, &playerId, &health, &onGround, &rotation, &headRotation]()
        {
            ...
            rotation.push_back(rotationArray[0].GetFloat());
            rotation.push_back(rotationArray[1].GetFloat());
            rotation.push_back(rotationArray[2].GetFloat());

            const auto headRotationArray = document["HeadRotation"].GetArray();
            headRotation.push_back(headRotationArray[0].GetFloat());
            headRotation.push_back(headRotationArray[1].GetFloat());
            headRotation.push_back(headRotationArray[2].GetFloat());
        };
